...
export const AboutMe = () => {
  ...
  return (
    <Grid container sx={{ gap: 2 }}>
      <Grid item md={3} sx={{ background: 'white', padding: 3, borderRadius: 3, marginTop: 3, height: 270 }}>
        <Box sx={{ width: '100%' }}>
          {data.map((item) => (
            <Button
              key={item.title}
      ...
      <Grid item md={8} sx={{ background: 'white', padding: 3, borderRadius: 3, marginTop: 3 }}>
        {renderComponent()}
      </Grid>
    </Grid>
  );
